    ...
    <>
      <div className="dashboard-content">
        <div className="form-header">
          <h2 className="form-title">Talepler</h2>
          <p className="form-description">
            Taleplerinizi buradan yönetebilir, yeni talepler ekleyebilir ve mevcut taleplerinizi güncelleyebilirsiniz.
            <br />
          </p>
        </div>
        <div class="container mt-5">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">Gelen Yeni Talepler</h4>
          ...
          <table class="table table-dark table-striped table-bordered align-middle">
            ...
            <tbody>
              <tr>
                ...
                <td>25</td>
                <td>
                  <button class="btn btn-sm btn-primary me-2">Cevapla</button>

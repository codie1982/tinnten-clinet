            ...
            <div className="form-container">
              <div className="container-fluid">
                ...
                <div className="form-header">
                  <h2 className="form-title form-title-start">Firma Bilgilerin</h2>
                  <h2 className="form-description form-description-start">Firma Bilgilerin</h2>
                  <h2 className="form-description form-description-start">Firma Bilgilerini girerek ön kayıt oluştur. Tinnten Ürün ve hizmet ekleme aşamasında sana bilgi verelim.</h2>
                </div>
                <Form onSubmit={handleSubmitForm}>
                  ...
                  <Form.Group as={Row} className="mb-3" controlId="formHorizontalName">
                    ...
                    <Col sm={5}>
                      ...
                      <Form.Text className="text-white">
                        Firma Adınız Tekil olmak zorunda.
                      </Form.Text>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} className="mb-3" controlId="formHorizontalBio">
                    ...
                    <Col sm={10}>
                      <Form.Control
                        ...
                        as="textarea"
                        defaultValue={""}
                        placeholder="Firmanı hakkında birkaç kelime yazın."
                        rows={3}
                      />
                      <Form.Text>
                  ...
                  <Form.Group as={Row} className="mb-3" controlId="formHorizontalPackage">
                    ...
                    <Col sm={4}>
                      <Button className="col btn m-t-2 btn-block btn-google-login" onClick={() => { openModal("buissnessPackages") }}>
                        Paketleri Gör
                      </Button>
                    </Col>
                  </Form.Group>

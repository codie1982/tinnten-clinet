...
export default function UpdateFormBuilder() {
  ...
  useEffect(() => {
    if (!isLoading && isSuccess && !isError) {
      toast.success("Form Başarı ile eklendi.")
    }
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      companyid: "6824aace3bd66ed798e41bbb", // Bu değişken component prop veya state olarak gelmeli
      formName,
      description,
      fields: fields.map((field) => {
        ...
        // Gereksiz alanları kaldır, sadece type'a göre ekle
        if (field.type === "file") {
    ...
    dispatch(addForm(payload)); // ✅ Backend kaydı için gönder
  };
              ...
              <Col md={6} className="pe-md-4 border-end" style={{ minWidth: "50%" }}>
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className="text-end mb-3">
                    <Button type="submit" disabled={isLoading} variant="success">Formu Kaydet</Button>
                  </div>

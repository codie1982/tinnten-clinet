  ...
  return (
    <main className="dashboard-content">
      <div className="form-header">
        <h2 className="form-title">Hizmetler</h2>
        <p className="form-description">
          Hizmetlerinizi buradan yönetebilir, yeni hizmet ekleyebilir ve mevcut hizmetlerinizi güncelleyebilirsiniz.
          <br />
        </p>
      </div>
      <Row>
        <Col>
          <div className="text-end mb-3">
            <Button type="submit" variant="success" onClick={() => { navigate("/dashboard/services/add") }}>Yeni Hizmet</Button>
          </div></Col>
      </Row>
